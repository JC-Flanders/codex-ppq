...
[](#deprecated-importmetaenvassets_prefix)
...
[](#deprecated-astroschema-and-z-from-astrocontent)
...
[](#deprecated-exposed-astrotransitions-internals)
...
[](#deprecated-nodeapp-from-astroappnode-adapter-api)
...
[](#deprecated-loadmanifest-and-loadapp-from-astroappnode-adapter-api)
...
[](#removed-exposed-astroactions-internals)
...
[](#removed-astrossr-manifest-virtual-module-integration-api)
...
[](#removed-routedatagenerate-adapter-api)
...
[](#removed-routes-on-astrobuilddone-hook-integration-api)
...
[](#removed-entrypoints-on-astrobuildssr-hook-integration-api)
...
[](#removed-old-apprender-signature-adapter-api)
...
[](#removed-appsetmanifestdata-adapter-api)
...
[](#changed-i18nroutingredirecttodefaultlocale-default-value)
...
[](#changed-importmetaenv-values-are-always-inlined)
