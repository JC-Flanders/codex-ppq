...
title: Ecommerce Arbitrage resale check | 402box
...
intro:
  ...
  title: One resale check. Inputs, caveats, and approvals.
...
results:
  ...
  title: A resale check shaped for buy/watch/skip decisions.
...
benefits:
  ...
  items:
    ...
    - title: Budget-first instructions
      text: The agent states planned tools, call counts, ranges, and stop conditions before spending or widening the scope of the resale check.
...
prompt:
  ...
  code: |-
    ...
    Do not buy, book, send, publish, file, register, sign wallet messages, pay invoices, submit forms, move funds, contact people, or mutate external systems without explicit approval. Ask before spending more than the approved budget or expanding beyond this resale check.
comparison:
  eyebrow: Comparison
  title: When a resale check beats another workflow.
...
useCases:
  eyebrow: Use cases
  title: Use the resale check when timing matters.
  items:
...
faq:
  eyebrow: FAQ
  title: Before the first resale check.
  items:
