...
title: Lead Enrichment on demand | 402box
...
bodyClass: page-bumi page-usecase page-02-lead-qualification-and-contact-enrichment
themeColor: "#101113"
...
schema:
  ...
  description: A pay-as-you-go lead enrichment workflow for agents that return a source-backed lead qualification packet.
  mainEntityName: Lead Qualification And Contact Enrichment
  mainEntityDescription: Combines lead, company, or domain, public source checks, priced endpoint calls, and review controls into a focused lead qualification packet.
  providerName: 402box
hero:
  backdrop:
    label: "02"
  ...
  lead: Give your agent a lead, company, or domain, source limits, and budget cap. Get a lead qualification packet with timestamps, costs, caveats, and approval boundaries before action.
  actions:
    - label: Budget first
  ...
  preview:
    ...
    responseAriaLabel: Example lead enrichment lead qualification packet
    resultLabel: Result
    ...
    code: |-
      {
        ...
        "packet": [
          "lead qualification packet: source-backed summary with timestamps.",
...
intro:
  ...
  title: One lead qualification packet. Evidence, costs, and next checks.
  text: Pay-as-you-go access is useful when lead, company, or domain needs a focused answer now, not a permanent provider stack. The agent returns a lead qualification packet with proof, costs, and next checks.
...
results:
  ...
  metrics:
    - label: Single Lead Fit Check
      value: $0.061-$0.151
      text: Single Lead Fit Check starts with cheap source checks and returns a narrow lead qualification packet before expansion.
      large: true
    ...
    - label: Expanded review run
      value: $0.025-$0.100
      text: Use only when the first lead qualification packet justifies more providers, deeper evidence, or repeated monitoring.
steps:
  ...
  items:
    ...
    - number: "04"
      ...
      text: Deliver the lead qualification packet, source links, cost notes, open questions, and actions that still need explicit human approval.
benefits:
  eyebrow: Benefits
...
facts:
  ...
  items:
    ...
    - label: Primary output
      value: lead qualification packet, timestamps, costs, caveats, and next checks
    - label: Dynamic costs
...
prompt:
  ...
  copyTarget: 02-lead-qualification-and-contact-enrichment-prompt
  ...
  code: |-
    ...
    Use the local Lead Enrichment workflow to return a lead qualification packet. Start by estimating the call budget from the tools you plan to use. Show the providers, planned calls, dynamic-price risks, expected total cost, and stop conditions before beginning.
...
comparison:
  ...
  rows:
    ...
    - category: Output
      ...
      right: One lead qualification packet with timestamps, costs, and candidates
    - category: Cadence
