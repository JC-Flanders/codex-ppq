...
title: Flight Monitoring route watch | 402box
...
intro:
  ...
  title: One route watch. Inputs, caveats, and approvals.
...
results:
  ...
  title: A route watch shaped for human decisions.
...
benefits:
  ...
  items:
    ...
    - title: Budget-first instructions
      text: The agent states planned tools, call counts, ranges, and stop conditions before spending or widening the scope of the route watch.
...
prompt:
  ...
  code: |-
    ...
    Do not buy, book, send, publish, file, register, sign wallet messages, pay invoices, submit forms, move funds, contact people, or mutate external systems without explicit approval. Ask before spending more than the approved budget or expanding beyond this route watch.
comparison:
  eyebrow: Comparison
  title: When one route watch beats another workflow.
...
useCases:
  eyebrow: Use cases
  title: Use the route watch when timing matters.
  items:
