...
title: Browser access check on demand | 402box
...
intro:
  ...
  title: One access check. Inputs, caveats, and approvals.
...
results:
  ...
  title: An access check shaped for human decisions.
...
benefits:
  ...
  items:
    ...
    - title: Budget-first instructions
      text: The agent states planned tools, call counts, ranges, and stop conditions before spending or widening the scope of the access check.
...
prompt:
  ...
  code: |-
    ...
    Do not buy, book, send, publish, file, register, sign wallet messages, pay invoices, submit forms, move funds, contact people, or mutate external systems without explicit approval. Ask before spending more than the approved budget or expanding beyond this access check.
comparison:
  eyebrow: Comparison
  title: When an access check beats another workflow.
...
useCases:
  eyebrow: Use cases
  title: Use the access check when timing matters.
  items:
...
faq:
  eyebrow: FAQ
  title: Before the first access check.
  items:
