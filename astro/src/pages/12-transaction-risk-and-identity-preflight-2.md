...
title: Risk Preflight card for review | 402box
...
intro:
  ...
  title: One preflight card. Inputs, caveats, and approvals.
...
results:
  ...
  title: A preflight card shaped for human decisions.
...
benefits:
  ...
  items:
    ...
    - title: Budget-first instructions
      text: The agent states planned tools, call counts, ranges, and stop conditions before spending or widening the preflight card.
...
prompt:
  ...
  code: |-
    ...
    Do not buy, book, send, publish, file, register, sign wallet messages, pay invoices, submit forms, move funds, contact people, or mutate external systems without explicit approval. Ask before spending more than the approved budget or expanding beyond this preflight card.
comparison:
  eyebrow: Comparison
  title: When a preflight card beats another workflow.
...
useCases:
  eyebrow: Use cases
  title: Use the preflight card when timing matters.
  items:
...
faq:
  eyebrow: FAQ
  title: Before the first preflight card.
  items:
